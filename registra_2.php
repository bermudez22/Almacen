            ...
            <div class ="row">
                ...
                <div class="col-4">
                    <br/>
                        ...
                        <br/>
                        <button id="boton1" class="btn btn-primary btn-block" type="submit">Iniciar Sesion</button>
                        <br/>
                        <p>¿No tienes cuenta?</p>
                        <button id="boton1" class="btn btn-primary btn-block"  onclick="registra();" type="submit">Registrate</button>
